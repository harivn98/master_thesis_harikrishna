...
# ── Stage 1 (SAM2) inputs ────────────────────────────────────────────────────
SAM2_CHUNK_START="${SAM2_CHUNK_START:-10}"
SAM2_CHUNK_END="${SAM2_CHUNK_END:-10}"
...
# ==============================================================================
SAM2_INPUT_PARENT="${SAM2_INPUT_PARENT:-gs://${GCS_BUCKET}/input/data_physical_ai}"
...
SAM2_OUTPUT_BASE="${SAM2_OUTPUT_BASE:-gs://${GCS_BUCKET}/outputs/sam2}"
SAM2_PREPROCESSED_OUTPUT_BASE="${SAM2_PREPROCESSED_OUTPUT_BASE:-gs://${GCS_BUCKET}/outputs/preprocessed_data_vp}"
...
# ==============================================================================
VP_OUTPUT_BASE="${VP_OUTPUT_BASE:-gs://${GCS_BUCKET}/outputs/vp}"
...
# ==============================================================================
ALPAMAYO_OUTPUT_BASE="${ALPAMAYO_OUTPUT_BASE:-/outputs/alpamayo}"
ALPAMAYO_MODEL_ID="${ALPAMAYO_MODEL_ID:-/all_checkpoints/alpamayo-r1-10b}"
